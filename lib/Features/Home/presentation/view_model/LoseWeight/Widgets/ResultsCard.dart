...
class _ResultsCardState extends State<ResultsCard>
  ...
  Widget build(BuildContext context) {
    ...
    String summary = isIdeal
        ? '${widget.bulkingPotentialScore} ${widget.healthAdvice}'
        : '${widget.deviationMessage} ${widget.bulkingPotentialScore} ${widget.healthAdvice}';
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              colors: [
                Color(0xff3b76f6), Color(0xff5c10a6)
